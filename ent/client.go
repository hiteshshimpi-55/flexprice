...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.Payment, c.PaymentAttempt, c.Plan, c.Price, c.PriceUnit, c.Secret,
...
func (c *GroupClient) QueryPrices(gr *Group) *PriceQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(price.Table, price.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, group.PricesTable, group.PricesColumn),
		)
...
func (c *PriceClient) QueryGroup(pr *Price) *GroupQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, true, price.GroupTable, price.GroupColumn),
		)
		fromV = sqlgraph.Neighbors(pr.driver.Dialect(), step)
		return fromV, nil
	}
...
type (
	hooks struct {
		...
		PriceUnit, Secret, Settings, Subscription, SubscriptionLineItem,
