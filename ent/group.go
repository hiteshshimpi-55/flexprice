...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case group.FieldID, group.FieldTenantID, group.FieldStatus, group.FieldCreatedBy, group.FieldUpdatedBy, group.FieldEnvironmentID, group.FieldName, group.FieldEntityType:
